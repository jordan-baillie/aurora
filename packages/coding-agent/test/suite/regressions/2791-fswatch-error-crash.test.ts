...
/**
 * Regression test for https://github.com/jordan-baillie/summon/issues/2791
 *
...
process.env.SUMMON_CODING_AGENT_DIR = "${agentDir}";
...
`,
		...
		try {
			_stdout = execFileSync(process.execPath, [scriptPath], {
				timeout: 10000,
				encoding: "utf-8",
				env: { ...process.env, SUMMON_CODING_AGENT_DIR: agentDir },
