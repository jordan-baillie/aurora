 ...
 * Commands Extension
 *
 * Demonstrates the summon.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@summon/coding-agent";

export default function commandsExtension(summon: ExtensionAPI) {
	summon.registerCommand("commands", {
