 ...
 * Delegates to @summon/ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   summon -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (summon: ExtensionAPI) {
	summon.registerProvider("gitlab-duo", {
