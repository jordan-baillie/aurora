 ...
 *   summon -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... summon -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (summon: ExtensionAPI) {
	summon.registerProvider("custom-anthropic", {
