 ...
 * (logo + keybinding hints) with a custom component showing the summon mascot.
 */

import type { ExtensionAPI, Theme } from "@summon/coding-agent";
import { VERSION } from "@summon/coding-agent";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the summon agent character
...
export default function (summon: ExtensionAPI) {
	...
	summon.registerCommand("builtin-header", {
