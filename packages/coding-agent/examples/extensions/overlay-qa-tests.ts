 ...
 *
 * Usage: summon --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@summon/coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@summon/tui";
import { matchesKey, truncateToWidth, visibleWidth } from "@summon/tui";
