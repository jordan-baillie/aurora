import { complete, getModel } from "@summon/ai";
import type { ExtensionAPI, ExtensionCommandContext } from "@summon/coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@summon/coding-agent";
import { Container, Markdown, matchesKey, Text } from "@summon/tui";
...
export default function (summon: ExtensionAPI) {
	summon.registerCommand("summarize", {
